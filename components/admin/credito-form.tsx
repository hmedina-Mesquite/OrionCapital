...
import type { ActionResult } from "@/app/(admin)/admin/creditos/actions"

export type CreditoFormDefaults = {
    ...
    <form action={formAction} className="space-y-4 max-w-xl" encType="multipart/form-data">
      <div className="grid gap-2">
        ...
        <Input
          ...
          required
          defaultValue={defaults?.nombre_proyecto ?? ""}
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="grid gap-2">
          <Label htmlFor="rfc_empresa">RFC empresa</Label>
          <Input
            id="rfc_empresa"
            name="rfc_empresa"
            defaultValue={defaults?.rfc_empresa ?? ""}
          />
        </div>
        <div className="grid gap-2">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="grid gap-2">
          ...
          <Input
            ...
            defaultValue={defaults?.contacto_nombre ?? ""}
          />
        </div>
        <div className="grid gap-2">
          <Label htmlFor="contacto_email">Correo contacto</Label>
          <Input
            id="contacto_email"
            name="contacto_email"
            type="email"
            defaultValue={defaults?.contacto_email ?? ""}
          />
        </div>
        <div className="grid gap-2">
          ...
          <Input
            ...
            defaultValue={defaults?.contacto_telefono ?? ""}
          />
        </div>
      </div>
      <div className="grid gap-2">
        ...
        <Input
          ...
          placeholder="Si ya creó cuenta, su correo de Supabase"
        />
        <p className="text-xs text-muted-foreground">
          Vincula con el perfil para que vea el crédito en su portal.
        </p>
      </div>
      <div className="grid gap-2">
